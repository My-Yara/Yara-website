...
<body style="margin:0;padding:0;background:#0B0D17;font-family:'DM Sans',-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;">
  <div style="max-width:520px;margin:0 auto;padding:40px 24px;">
    ...
    <div style="background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.08);border-radius:20px;padding:24px;margin-bottom:20px;">
      <p style="color:rgba(255,255,255,0.85);font-size:15px;line-height:1.65;margin:0 0 14px;">Thanks for signing up — we're glad you're here.</p>
      <p style="color:rgba(255,255,255,0.7);font-size:14px;line-height:1.65;margin:0;">Yara is an AI advocate that fights to save you money. She analyzes your bills, finds overcharges and better deals, then takes action — negotiating with providers, switching plans, and cancelling services you don't need. No more sitting on hold.</p>
    </div>
